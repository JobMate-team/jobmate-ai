...

{
  "groups": [
    ...
    },
    {
      ...
      "questions": [
        {
          "page_text": "인사팀 역할 이해 및 지원 동기",
          "metadata": {
            "question_id": "HR-HRManager-005",
            "question_type": "job",
            "competency_tags": [
              "hr_insight",
            ...
            "feature": "question",
            "question_text": [
              "당사에서 인사팀이 무슨 역할을 할 수 있는가?",
              "인사팀이 조직 내에서 수행해야 하는 핵심 역할은 무엇이라고 생각하나요?",
              "왜 당사에 지원했는가?",
              "당사에서 지원한 인사 직무를 수행하는 것이 본인에게는 어떤 의미인가?"
            ]
          }
        }
      ]
    ...
    },
    {
      ...
      "questions": [
        {
          "page_text": "HRD 관심 계기와 지원 동기",
          "metadata": {
            "question_id": "HR-HRManager-010",
            "question_type": "experience",
            "competency_tags": [
              "self_awareness",
              "leadership"
            ...
            "feature": "question",
            "question_text": [
              "이력서 보니까 이걸 통해서 HRD에 관심이 있게 된 계기 같은데 이 경험을 통해 배운게 뭔가요?",
              "해당 경험이 인사·HRD 업무에 관심을 갖게 된 계기가 되었나요? 그렇다면 무엇을 느끼고 배웠는지 설명해 주세요.",
              "근무하고 싶은 이유가 무엇인가요?"
            ]
          }
        }
